package com.blogsystemarticleprovider;
...
//表示开启Fegin客户端
@EnableFeignClients
public class BlogSystemArticleProviderApplication {

    public static void main(String[] args) {
        SpringApplication.run(BlogSystemArticleProviderApplication.class, args);
    }
