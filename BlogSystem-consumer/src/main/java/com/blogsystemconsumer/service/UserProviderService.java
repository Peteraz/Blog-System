package com.blogsystemconsumer.service;

import com.blogsystemconsumer.Hystrix.HystrixUserClientService;
...
public interface UserProviderService {
    ...
    String getRegister(@RequestBody Map<String,String> map);
