package com.blogsystemcommentprovider;
...
//表示开启Fegin客户端
@EnableFeignClients
public class BlogSystemCommentProviderApplication {

    public static void main(String[] args) {
        SpringApplication.run(BlogSystemCommentProviderApplication.class, args);
    }
